                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="form-group col-7">
                                ...
                                <input type="number" class="form-control" value="{{old('contact_number')}}" id="contact-number" name="contact_number" required>
                            </div>
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="mb-4">Note: This templete is used for example. Your selected templete will be used after register and You can change templete anytime.</p>
