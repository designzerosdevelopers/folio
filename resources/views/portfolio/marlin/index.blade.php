...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="{{ asset('portfolio_assets/marlin/css/styles.css')}}">
    ...
    <body>
                ...
                <div class="home__img">
                    <svg class="home__blob" viewBox="0 0 479 467" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                        <g mask="url(#mask0)">
                            ...
                            <image class="home__blob-img" x="80" y="30" href="{{ asset('portfolio_assets/marlin/img/perfil.jpg')}}"/>
                        </g>
                    </svg>
                </div>
            </section>
        ...
        <!--===== MAIN JS =====-->
        <script src="{{ asset('portfolio_assets/marlin/js/main.js')}}"></script>
    </body>
</html>
