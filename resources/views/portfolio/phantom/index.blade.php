...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('portfolio_assets/phantom/plugins/bootstrap/bootstrap.min.css')}}">
  <link rel="stylesheet" href="{{ asset('portfolio_assets/phantom/plugins/animate.css')}}">
  <link rel="stylesheet" href="{{ asset('portfolio_assets/phantom/plugins/slick/slick.css')}}">
  <link rel="stylesheet" href="{{ asset('portfolio_assets/phantom/plugins/slick/slick-theme.css')}}">
  <link rel="stylesheet" href="{{ asset('portfolio_assets/phantom/plugins/themefisher-fonts/css/themefisher-fonts.min.css')}}">  

  <!-- Main Stylesheet -->
  <link rel="stylesheet" href="{{ asset('portfolio_assets/phantom/css/style.css')}}">
  
  <!-- Theme Stylesheet -->
  <link rel="stylesheet" href="#" id="color-changer">
  
  <!--Favicon-->
  <link rel="icon" href="{{ asset('portfolio_assets/phantom/images/favicon.png')}}" type="image/x-icon">
...
Essential Scripts
=====================================-->
<script src="{{ asset('portfolio_assets/phantom/plugins/jquery-2.2.4.min.js')}}"></script>
<script src="{{ asset('portfolio_assets/phantom/plugins/bootstrap/bootstrap.min.js')}}"></script>
<script src="{{ asset('portfolio_assets/phantom/plugins/jquery.nicescroll.min.js')}}"></script>
<script src="{{ asset('portfolio_assets/phantom/plugins/isotope/isotope.pkgd.min.js')}}"></script>
<script src="{{ asset('portfolio_assets/phantom/plugins/slick/slick.min.js')}}"></script>

<script src="{{ asset('portfolio_assets/phantom/js/script.js')}}"></script>
