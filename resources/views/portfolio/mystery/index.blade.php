...
<head>
    ...
    <link href="{{ asset('portfolio_assets/mystery/lib/owlcarousel/assets/owl.carousel.min.css')}}" rel="stylesheet">
    <link href="{{ asset('portfolio_assets/mystery/lib/lightbox/css/lightbox.min.css')}}" rel="stylesheet">

    <!-- Customized Bootstrap Stylesheet -->
    <link href="{{ asset('portfolio_assets/mystery/css/style.css')}}" rel="stylesheet">
</head>
...
<body data-spy="scroll" data-target=".navbar" data-offset="51">
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-7 text-center text-lg-left">
                    ...
                    <h1 class="display-3 text-uppercase text-primary mb-2" style="-webkit-text-stroke: 4px #ffffff;">Alaxe Smith</h1>
    ...
    <script src="{{ asset('portfolio_assets/mystery/lib/typed/typed.min.js')}}"></script>
    <script src="{{ asset('portfolio_assets/mystery/lib/easing/easing.min.js')}}"></script>
    <script src="{{ asset('portfolio_assets/mystery/lib/waypoints/waypoints.min.js')}}"></script>
    <script src="{{ asset('portfolio_assets/mystery/lib/owlcarousel/owl.carousel.min.js')}}"></script>
    <script src="{{ asset('portfolio_assets/mystery/lib/isotope/isotope.pkgd.min.js')}}"></script>
    <script src="{{ asset('portfolio_assets/mystery/lib/lightbox/js/lightbox.min.js')}}"></script>


    <!-- Template Javascript -->
    <script src="{{ asset('portfolio_assets/mystery/js/main.js')}}"></script>
</body>
